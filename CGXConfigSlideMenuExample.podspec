Pod::Spec.new do |s|
  ...
  s.summary      = "a CGXSlideMenuView demo标签封装"  #简介
  s.description  = "a CGXSlideMenuView菜单封装"  #描述
  s.homepage     = "https://github.com/974794055/CGXConfigSlideMenuExample"      #项目主页，不是git地址
  s.license      = { :type => "MIT", :file => "LICENSE" }   #开源协议
  s.author             = { "974794055" => "974794055@qq.com" }  #作者
  s.platform     = :ios, "7.0"                  #支持的平台和版本号
  s.source       = { :git => "https://github.com/974794055/CGXConfigSlideMenuExample.git", :tag =>        s.version }         #存储库的git地址，以及tag值
